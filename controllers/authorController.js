...
//Disp Author CREATE form on GET
...
exports.author_create_post = [
    ...
    body("first_name")
      ...
      .isAlpha()
      .withMessage("First name has non-alphabet characters."),
    body("family_name")
      .trim()
      .isLength({ min: 1 })
      .escape()
      ...
      .isAlpha()
      .withMessage("Family name has non-alphabet characters."),
...
//Disp Author UPDATE form on GET
